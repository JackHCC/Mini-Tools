...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action.setStatusTip("Find out more about ")  # Hungry!
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - CC" % title)

    def navigate_mozarella(self):
        self.browser.setUrl(QUrl("https://baidu.com"))
...
app.setOrganizationDomain("CC.org")
